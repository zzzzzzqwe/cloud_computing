...
# Задача
В этой лабораторной работе требуется изучить базовые принципы облачных вычислений на платформе AWS, научиться создавать и управлять виртуальными машинами с помощью сервиса EC2.
